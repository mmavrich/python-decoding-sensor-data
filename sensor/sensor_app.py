...
print("\nHouse Humidity sensor records for the area {} = {}".format(test_area, len(recs)))
print("\tAverage: {} humidity".format(mean(recs)))

recs=humidity_data.get_data_by_date(rec_date=test_date)
print("\nHouse Humidity sensor records for the date: {} = {}".format(test_date.strftime("%m/%d/%y"), len(recs)))
print("\tAverage: {} humidity".format(mean(recs)))
# Module 5 code here:
